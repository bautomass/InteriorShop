...
//         }}
//       />
//       <div className="mx-auto max-w-screen-2xl px-4 relative pt-20 pb-24">
//         <div className="absolute top-0 right-0 w-[80%] h-[80%] bg-[#eaeadf] opacity-90 blur-[150px] pointer-events-none" />
//         <div className="flex flex-col p-8 md:p-12 lg:flex-row lg:gap-26 max-w-[1400px] mx-auto relative">
//           <div className="h-full w-full max-w-[550px] mx-auto basis-full lg:basis-[45%]">
//             <ProductGallery images={product.images} product={product} />
//           </div>
//           <div className="basis-full lg:basis-[45%]">
//             <ProductDetails product={product} />
...
//   return <RelatedProductsClient products={relatedProducts} />;
// }
