...
const ProductCard = ({ product, snippet }: { product: Product; snippet: string }) => (
  <Link 
  ...
  >
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#6B5E4C]/90 via-[#6B5E4C]/40 
        ...
        <button 
          onClick={(e) => {
            e.preventDefault(); // Prevent navigation when clicking view button
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        onHoverEnd={() => setTimeout(() => setIsScrolling(true), 200)}
      ...
      >
        {[...products, ...products].map((product, index) => (
          <ProductCard
            ...
            product={product}
            snippet={productSnippets[index % products.length]}
          />
        ))}
      </motion.div>
    </div>
...
export default InfiniteProductBanner;
