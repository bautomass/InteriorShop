                            ...
                            >
                              ...
                              <div className="border-b border-[#6B5E4C]/10 pb-3">
                                <div className="flex justify-between items-center">
                                  <h3 className="text-base md:text-lg font-semibold text-[#6B5E4C]">
                                    Shopping Cart
                                  </h3>
                              ...
                              <div className="max-h-[40vh] md:max-h-[50vh] overflow-y-auto my-3 pr-2 
                                ...
                                {(cart.lines as any[]).map((item) => (
                                  <motion.div
                                    key={item.id}
                                    layout
                                    className="flex gap-3 md:gap-4 rounded-md p-3 hover:bg-[#6B5E4C]/5 
                                             border-b border-[#6B5E4C]/10 last:border-b-0"
                                  >
                                    {item.merchandise.product.featuredImage && (
                                      <div className="relative h-16 w-16 md:h-20 md:w-20 flex-shrink-0 
                                                    overflow-hidden rounded-md bg-[#F8F7F6]">
                                        <Image
                              ...
                              <div className="border-t border-[#6B5E4C]/10 pt-3 space-y-2.5">
                                <div className="flex justify-between items-center mb-4">
                                  <span className="text-sm md:text-base font-medium text-[#8C7E6A]">
                                    Subtotal
                                  </span>
                                ...
                                <button
                                  onClick={() => setIsCartOpen(true)}
                                  className="w-full rounded-md bg-[#6B5E4C] px-4 py-2.5 text-sm md:text-base 
                                           font-medium text-white transition-colors hover:bg-[#5A4D3B]"
                                >
                                  View Cart
                                </button>
                                <button
                                  ...
                                  className="w-full rounded-md bg-[#6B5E4C]/10 px-4 py-2.5 text-sm md:text-base 
                                           font-medium text-[#6B5E4C] transition-colors hover:bg-[#6B5E4C]/20 
                    ...
                    >
                      ...
                      >
                        <input
                          type="text"
                          placeholder="Search..."
                          className="w-full appearance-none bg-transparent px-4 py-2 text-white placeholder-white/70 
                        ...
                        {isSearchOpen && searchQuery && (
                          <motion.div 
                            ...
                            exit={{ opacity: 0, y: -10 }}
                            transition={{ duration: 0.2 }}
                            className="absolute top-full right-0 w-[400px] mt-3 bg-white/95 backdrop-blur-md 
                                     rounded-lg shadow-2xl overflow-hidden z-50 border border-neutral-200"
                          ...
                          >
                            ...
                            {(results.products.length + results.collections.length) > 5 && (
                              <div className="p-4 bg-neutral-50 border-t border-neutral-200">
                                <button
                                  onClick={() => openModal()}
                                  className="w-full py-2.5 px-4 text-sm text-center text-white bg-[#9e896c] rounded-lg 
                                           hover:bg-[#8a775d] transition-colors focus:outline-none focus:ring-2 
                                           focus:ring-[#9e896c] focus:ring-offset-2"
                                >
...
value={searchQuery}
onChange={(e) => setSearchQuery(e.target.value)}
className="w-full px-4 py-3 text-lg text-neutral-900 bg-neutral-100 rounded-lg 
       focus:outline-none focus:ring-2 focus:ring-[#9e896c] focus:bg-white transition-all pr-12"
/>
</div>
...
{(cart?.totalQuantity ?? 0) > 0 && (
  <motion.span
    ...
    className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center 
             rounded-full bg-[#9e896c] text-xs font-medium text-white"
  >
    {cart?.totalQuantity ?? 0}
  </motion.span>
)}
...
<div className="absolute left-0 top-full mt-2 bg-white rounded-lg shadow-xl border border-neutral-200 
          p-4 min-w-[200px] opacity-0 invisible group-hover:opacity-100 
