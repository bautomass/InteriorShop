...
//       aria-label={type === 'plus' ? 'Increase item quantity' : 'Reduce item quantity'}
//       className={clsx(
//         'ease flex h-full min-w-[36px] max-w-[36px] flex-none items-center justify-center rounded-full p-2 transition-all duration-200 hover:border-primary-800 hover:opacity-80',
//         {
//           'ml-auto': type === 'minus'
//         }
//       )}
//     >
//       {type === 'plus' ? (
//         <PlusIcon className="h-4 w-4 text-primary-600 dark:text-primary-400" />
//       ) : (
//         <MinusIcon className="h-4 w-4 text-primary-600 dark:text-primary-400" />
//       )}
//     </button>
//   );
// }
